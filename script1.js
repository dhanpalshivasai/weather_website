...
fetch('https://api.openweathermap.org/data/2.5/forecast?q='+newName.value+'&appid=a259f49c7b7b7951cfa84b321f83d907')
...
.catch(err => alert("Something Went Wrong: Try Checking Your Internet Connection/Enter proper Location"))
}
